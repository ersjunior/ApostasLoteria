...
def generate_statistics_pdf(df, total_bolas: int, titulo: str = "Relatório Estatístico"):
    ...
    empirical_probability(df, total_bolas=total_bolas)
    buffer = BytesIO()
    ...
    # TÍTULO
    # =========================
    elements.append(Paragraph("<b>Mega-Sena Analyzer</b>", styles["Title"]))
    elements.append(Spacer(1, 8))

    elements.append(
        Paragraph("Relatório Estatístico Completo - Histórico da Mega-Sena", styles["Heading2"])
    )
